<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="{{ url('/') }}">
        <img class="navbar-brand-full" src="{{ config('appsetting.basic.main_logo') }}" width="89" height="25" alt="CoreUI Logo">
        <img class="navbar-brand-minimized" src="{{ config('appsetting.basic.main_logo') }}" width="30" height="30" alt="CoreUI Logo">
    </a>
