...
@section ('title', __('client::labels.backend.client.management') . ' | ' . __('client::labels.backend.client.create'))
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('client::labels.backend.client.create') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
