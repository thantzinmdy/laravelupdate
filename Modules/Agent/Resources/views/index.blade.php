...
@section ('title', app_name() . ' | ' . __('agent::labels.backend.agent.management'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('agent::labels.backend.agent.management') }} <small class="text-muted">{{ __('agent::labels.backend.agent.list') }}</small>
                </h4>
            </div><!--col-->

            <div class="col-sm-7">
                @include('agent::includes.header-buttons')
            </div><!--col-->
        </div><!--row-->
