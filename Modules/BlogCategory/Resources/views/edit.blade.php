...
@section ('title', __('blogcategory::labels.backend.blogcategory.management') . ' | ' . __('blogcategory::labels.backend.blogcategory.edit'))
...
@section('content')
{{ html()->modelForm($blogCategory, 'PATCH', route('admin.blogcategory.update', $blogCategory->id))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('blogcategory::labels.backend.blogcategory.edit') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
