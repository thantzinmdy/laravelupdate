...
- Laravel mix configuration (https://Thantzin.com/laravel-boilerplate-modules/v3/basic-usage/compiling-assets)
...
- Module generation namespace now works with `StudlyCase` ([Issue #14](https://github.com/Thantzin/laravel-boilerplate-modules/issues/14))
