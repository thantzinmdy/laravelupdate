...
use Thantzin\Modules\Exceptions\InvalidAssetPath;
use Thantzin\Modules\Exceptions\ModuleNotFoundException;
use Thantzin\Modules\Process\Installer;
use Thantzin\Modules\Process\Updater;
...
abstract class Repository implements RepositoryInterface, Countable
{
     ...
     * @param $name
     * @param $path
     * @return \Thantzin\Modules\Module
     */
     ...
     * @return string
     * @throws \Thantzin\Modules\Exceptions\ModuleNotFoundException
     */
